namespace HighwayToPeak.Utilities.Messages
{
    public class OutputMessages
    {
        ...
        public const string PeakDifficultyLevelInvalid = "{0} peaks are not allowed for international climbers.";
        ...
        //Шибана грешка, във готовия файл
        ...
        public const string NotSuccessfulAttack = "{0} did not return to BaseCamp.";
